...
The main reason I want to donate now rather than wait till I'm at or
...
If my savings continue to increase, slowly and steadily, should I
...
simplicity, I've decided against making *continuous* changes to the
...
of where I am with respect to savings).
...
My current thinking is to not let windfall profits affect the donation
budget, at least for profits that comprise less than one additional
year of net saving.

### Borrowing against future donation budget

What if I find a truly compelling and time-sensitive opportunity, and
I want to donate more to it than my donation budget allows? In extreme
cases, I'm open to the idea of *borrowing against my future donation
budget*. I consider this fairly unlikely in the near term, partly
because I've already accumulated a fair amount in the donation budget.
...
In [my Q4 2021 donation
post](https://vipulnaik.com/blog/my-somewhat-unusual-q4-2021-donation/),
I talked about fallback donation targets. I wrote:
...
One update over the last year has been in terms of the existence of
...
* There aren't that many compelling and time-sensitive opportunities
  ...
  make me want to investigate it more.
...
Given the above factors, I've been leaning more toward making
...
have several (related) advantages:

* They are regrantors rather than grant endpoints, and they have a
...
* They are more legible and therefore give me a stronger sense of
  having "done good" with my donation, as well as communicate to
  others more clearly that I'm doing good. They offer a credible
  signal of my "effective altruist" sympathies.

* My incremental investigative effort is limited to choosing between
  ...
  "damage done" seems relatively small.

A more general point is that, based on responses to my [regrets
post](https://forum.effectivealtruism.org/posts/xvebegCf8NReJc2Lw/what-regrets-have-you-had-regarding-past-donations),
...
own use case, but I should probably expect *less* regret from my
future self than my current self feels in anticipation.
...
The trade-off feels real to me: do I keep more money (within my
donation budget) for potential compelling opportunities, or do I get
money out the door?

Overall, I think that *if* I were able to find compelling and
time-sensitive opportunities that use up my donation budget, I'm happy
to spend on those and not donate to fallback donation targets *at all*
...
iconoclasm is more high-variance.

However, I don't expect to be able to find enough compelling and
time-sensitive opportunities that use up my donation budget, and I
want to get money out the door soon. So how do I square this?

### My solution for now: minimum fallback donation target assuming enough donation budget

The idea I had is to do a periodic (e.g., end-of-year) evaluation as
...
Funds and the GiveWell Maximum Impact Fund).

Here's how I justify this solution.

#### "Small enough" for the donation target

All the listed fallback donation targets have annual spends ranging
...
$5,000 is big enough for the donation target that I don't feel like
I'm wasting their time. It falls at level 2 in my [levels of donation
...
* Since this allocation is done only *if* I have at least $10,000
...
* It's pretty much guaranteed that the fallback donation targets won't
...
I'm currently undecided between whether to start applying fallback
donation targets starting with end-of-2022 or wait till end-of-2023.

#### The argument for waiting till 2023

I had originally planned to spend a significant amount of time in 2022
on the [donations list website](https://donations.vipulnaik.com/) as
...
However, 2022 was a year of several other changes for me, including a
[job
change](https://www.facebook.com/vipulnaik.r/posts/pfbid0dgmmVwD9inUHA9TYCQn84vtaCGn5Cvk8HAmVuWekGFzpaTh2UoohXjWjTxjvRdTcl)
...
hosting my websites, and my current plan is to [focus on this devops
...
* In general, the argument for doing this is also an argument for
  doing this *now*. Much of the argument is not sensitive to the exact
  start date, and it makes sense to start sooner rather than later.

* I already made a donation in January of 2022 that just about gets me
  past the standard deduction, so I get donation bunching benefits by
  starting in 2022.

* I expect to make a windfall of money related to exercising and
...
Overall, I'm leaning toward starting in 2022, but I plan to continue
to think about this through October and November to see if other
considerations come up that I hadn't thought of before.

## Selecting between fallback donation targets

I am not making a decision right now, but when I do, I will likely
pick between one of the four EA Funds:
...
While I was initially thinking of the GiveWell Maximum Impact Fund /
...
to GiveWell top charities if it doesn't find better opportunities.

### I would have liked to have the donations list website up-to-date before this analysis!

It would have been good if the [donations list
website](https://donations.vipulnaik.com/) included up-to-date
...
the fund pages on the EA Funds site (as linked above).
...
The Global Health and Development Fund seems to be fairly well-funded;
...
more money. Open Philanthropy alone has been [upping its
allocation](https://www.openphilanthropy.org/research/update-on-our-planned-allocation-to-givewells-recommended-charities-in-2022/)
to GiveWell top charities.

While I do think that what GiveWell is doing is very valuable, it
...
to be close to the most cost-effective.

### Comparing animal welfare, the long-term future, and EA infrastructure

I think animal welfare matters, and I think the long-term future
...
at least [Luke's 2013
post](https://forum.effectivealtruism.org/posts/pfbLKnJmDKYSPPCEW/four-focus-areas-of-effective-altruism)
...
All three areas seem important and neglected. All of them have
...
* Animal welfare seems the most *neglected*, though it's hard to say
  ...
  * The existence of players such as FTX Future Fund and the Survival
    ...
    all on animal welfare, partly informs this view.

  * Even among the EA Funds, the Animal Welfare Fund seems to have the
    smallest budget.

* Animal welfare seems to naively be the most tractable, but it's not
  ...
  welfare movements around the world.

Given all these considerations, I'm leaning toward treating animal
...
*didn't* exist, I might well have gone with the Long-Term Future Fund
as my top choice.

I have more thoughts on this, including thoughts on how to justify
